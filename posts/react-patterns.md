...
리액트 생태계는 굉장히 크기 때문에 당연히도 다양한 디자인 패턴들이 있고 그 중 몇 가지를 학습해서 이를 다시 한 번 포스팅을 하면서 정리해보고자 합니다. 다양한 디자인 패터에 대해서 알고 싶으시다면 [해당 링크](https://www.patterns.dev/posts/#design-patterns)를 참고해보시면 좋을 것 같습니다.
